 ...
 *  - SS310 Diodes
 */
#define BLYNK_TEMPLATE_ID "TMPL6-HCPjAxO"
#define BLYNK_TEMPLATE_NAME "ESP32 MPPT Controler"
#define BLYNK_AUTH_TOKEN "SB7gdNOjXYuXSZaz3uJoasxvQQFa6UNu"
...
String 
firmwareInfo      = "V1.10   ",
firmwareDate      = "15/10/24",
firmwareContactR1 = "01931974157",  
firmwareContactR2 = "Md Yasin Arafat";        
...
//==================================================================================================//
#define backflow_MOSFET 27          //SYSTEM PARAMETER - Backflow MOSFET Pin D27
#define buck_IN         26          //SYSTEM PARAMETER - Buck MOSFET Driver PWM Pin D26
#define buck_EN         25          //SYSTEM PARAMETER - Buck MOSFET Driver Enable Pin D25
#define LED             2           //SYSTEM PARAMETER - LED Indicator GPIO Pin D2
#define FAN             16          //SYSTEM PARAMETER - Fan GPIO Pin D16/RX2
#define TempSensor      35          //SYSTEM PARAMETER - Temperature Sensor GPIO Pin D35
#define buttonLeft      18          //SYSTEM PARAMETER - Button Control Pin D18
#define buttonRight     17          //SYSTEM PARAMETER - Button Control Pin D17/TX2
#define buttonBack      19          //SYSTEM PARAMETER - Button Control Pin D19
#define buttonSelect    23          //SYSTEM PARAMETER - Button Control Pin D23

#define IOT_Not_LED     15          // D15 IOT Disconnected LED Output
#define IOT_LED         5           // D5 IOT Connected LED Output
#define WiFi_Not_LED    4           // D4 WiFi Not Connected LED Output
#define WiFi_LED        14          // D14 WiFi Connected LED Output

int IVSR = 33;            // Read Input Voltage Pin D33
int OVSR = 32;            // Read Output Voltage Pin D32
int OCSR = 34;            // Read Output Current Pin D34

//  CALIB PARAMETER - Input voltage divider sensor ratio (change this value to calibrate voltage sensor)
int IVSRKOh1 = 10;        // 10KOhm Res For GND to IVSR Pin
int IVSRKOh2 = 100;       // 10KOhm Res For Input Voltage to IVSR Pin

 //  CALIB PARAMETER - Output voltage divider sensor ratio (change this value to calibrate voltage sensor)
int OVSRKOh1 = 10;        // 10KOhm Res For GND to OVSR Pin
int OVSRKOh2 = 100;       // 10KOhm Res For Output Voltage to OVSR Pin
...
char ssid[] = "Infinix SMART 5";
char pass[] = "mdarafat01931";
...
ntcResistance           = 10.00,    //  CALIB PARAMETER - NTC temp sensor's resistance. Change to 100.00 if you are using a 100k NTC
...
currentMidPoint         = 1.650,     //  CALIB PARAMETER - Current Sensor Midpoint (V)
...
void setup() { 
  ...
  pinMode(IOT_Not_LED, OUTPUT);
  pinMode(IOT_LED, OUTPUT);
  pinMode(WiFi_Not_LED, OUTPUT);
